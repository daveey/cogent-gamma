...
def scramble_target_score(
    *,
    ...
    corner_pressure = min(manhattan(hub_position, candidate.position) / 7.52, 10.94)  # Increased divisor from 7.51 to 7.52 (+0.13%) for bidirectional pressure growth tuning
