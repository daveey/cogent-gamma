...
def scramble_target_score(
    *,
    ...
    corner_pressure = min(manhattan(hub_position, candidate.position) / 7.50, 10.92)  # Reduced divisor from 7.52 to 7.50 (-0.27%) for bidirectional pressure growth tuning
